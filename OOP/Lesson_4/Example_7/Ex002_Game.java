package OOP.Lesson_4.Example_7;
...
public class Ex002_Game {
    public static void main(String[] args) {
        ...
        // Но опять проблема. Можно создать команду строк.
    }
}
...
class Team<T> {                            // Тип команды необходим для разбиения их на лиги.
    private String name;
...
class Olympiad<T> {      // Олимпиада будет проводиться между командами одного типа - лиги. Тип закрывающего обобщения.
    Team<T> team1, team2;
    Random r = new Random();
