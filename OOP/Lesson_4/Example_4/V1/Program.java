...
// Задача: создать хранилище audio и video файлов. Отдельная папка, которая позволяет добавлять в себя только audio и video файлы.
// Проблемы классического полиморфизма.
public class Program {
    ...
    // проблема полиморфизма. В audioStorage можно добавить видео контент.
        // Есть базовый тип Content от которого наследуются audioStorage и videoStorage. В Repository используется тип данных <Content>.
